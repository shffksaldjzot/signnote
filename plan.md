...
### Phase 9: 주관사/관리자 웹 ✅
- [x] 관리자 웹 프로젝트 설정 (Flutter Web + GoRouter ShellRoute)
- [x] 행사 생성/관리 대시보드
- [x] 품목 관리 화면
- [x] 매출/계약/정산 대시보드
- [x] 사용자 관리
...
### Phase 10: 알림 시스템 ✅
- [x] FCM 푸시 알림 연동 (키 설정 시 동작, 구조 완성)
- [x] 카카오 알림톡 연동 (키 설정 시 동작, 구조 완성)
- [x] 알림 발송 로직 (계약 생성/취소 요청/승인/거부 이벤트 연결)

### Phase 5: PG 결제 보강 ✅
- [x] 결제 완료 시 정산 자동 생성 연결
- [x] 결제 완료 시 고객 알림 발송 연결
- [x] 테스트 모드(PG 없이 동작) 유지 — 나중에 키만 설정

### Phase 7: 정산 분배 ✅
- [x] 정산 서비스 (자동 생성, 수수료 계산, 지급/완료)
- [x] 정산 API 6개 (전체/업체/요약/상세/지급/완료)
- [x] 주관사 웹 정산 관리 페이지
