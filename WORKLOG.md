...
<!-- 새 항목은 이 아래에 추가 -->
1. 주관사는 파트너스를 관리 할수 있긴한데, 해당주관사가 만든 행사에 참여 요청한 협력업체만 볼수있어야돼.
2. 항상 사인노트 로고를 누르면 홈으로 이동하게 해줘.
3. 주관사 대시보드에 행사 생성 버튼이 없어 이거 만들어줘.
4. 테스트 하게 더미 행사 하나 만들어서 코드 알려줘.
5. 어드민은 대시보드 로고 아래 어드민 배지 달아주고 주관사는 주관사 배지 달아줘야지. 지금 혼용되고있는건지 아니면 주관사랑 어드민이랑 같은 개념으로 알고있는건지 궁금하네 어드민하고 주관사는 별개야. 이거 확인해서 나한테 알려줘